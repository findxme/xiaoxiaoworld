                    ...
                    <div class="layui-form" lay-filter="">
                        <form>
                            <div class="layui-form-item">
                                ...
                                <div class="layui-form-mid layui-word-aux">读者</div>
                            </div>
                            <div class="layui-form-item">
                                <label class="layui-form-label">用户名</label>
                                <div class="layui-input-inline">
                                    <input type="text" name="username" value="${userName}" readonly id="readerUserName" class="layui-input">
                                </div>
...
<script>
    layui.use('form', function () {
        ...
        form.on('submit(formDemo)', function(data){
            ...
            //
            // alert($("#remarks").val());
            // alert($("#readerUserName").val());
            $.ajax({
                type: 'POST',
                url: "${ctx}/readerView/setUser",
                data: {
                    email: $("#email").val(),
                    remarks: $("#remarks").val()
                },
